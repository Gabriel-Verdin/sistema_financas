...
def editar_transacao(id_transacao):
    while True:
        ...
        if escolha_int is not None:
            ...
            elif escolha_int == 4: # Tipo
                novo_tipo = input('Digite o novo tipo (Despesa / Receita): ')

                cursor.execute("UPDATE transacao SET tipo = ? WHERE id_transacao = ?", (novo_tipo, id_transacao))

            elif escolha_int == 5: # Forma de Pagamento
                print()
