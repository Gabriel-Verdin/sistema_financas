    ...
    while True:
        ...
        if escolha_int is not None:
            if escolha_int == 1:
                ...
                tipo_nova_categoria = input('Digite o tipo padrão da categoria (Despesa/Receita): ').lower()
                tipo_nova_categoria_valida = validacoes.despesa_ou_receita(tipo_nova_categoria)

                if tipo_nova_categoria_valida is not None:
                ...
                id_categoria_int = validacoes.str_para_int(id_categoria_str)
                id_categoria_valida = validacoes.escolha_valida_categoria(id_categoria_int)

                if id_categoria_int is not None and id_categoria_valida is not None:
                    novo_nome = input('Digite o novo nome da categoria (nada para manter o atual): ')
                    novo_tipo = input('Digite o novo tipo da categoria (nada para manter o atual): ').lower()

                    novo_tipo_valido = validacoes.despesa_ou_receita(novo_tipo)

                    if novo_tipo_valido is not None:
